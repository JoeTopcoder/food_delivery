// AUTO-GENERATED for the consolidated `packages` function.
// Verbatim copy of supabase/functions/assign-driver-multi-pickup/index.ts with only the
// serve() wrapper turned into an exported handle() and import depth fixed.
// Business logic is unchanged. Regenerate via scratchpad/build_domain.py.
