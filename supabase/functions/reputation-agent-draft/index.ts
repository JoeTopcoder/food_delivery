// reputation-agent-draft — Reputation Management Agent (HotBite AI Operations)
    ...
    const res = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are the HotBite Reputation Management Agent, drafting a PUBLIC reply to a customer review that other customers will see. Rules:
...
Known issues from other HotBite agents about this restaurant:
${crossAgentSummary}`,
          },
        ],
