-- Fix cancel_order_with_penalty:
-- 1. Cast total_amount to numeric before ROUND() (double precision overload doesn't exist)
-- 2. Allow cancellation from 'accepted' and 'draft' statuses
