-- Restore the 30 Cayman restaurants + their menus from supabase/seed_data_cayman.sql
-- (users + restaurants + menu items sections only — orders/drivers/payments/reviews
-- deliberately excluded, not needed and higher risk of schema drift).
BEGIN;
-- ====================================================================
