...
class _BankInfoScreenState extends ConsumerState<BankInfoScreen> {
  ...
  static const Map<String, List<String>> _bankBranches = {
    ...
    'Butterfield Bank (Cayman)': ['George Town', 'Camana Bay'],
    'CIBC FirstCaribbean': ['George Town', 'Seven Mile Beach', 'Camana Bay'],
    'Scotiabank & Trust (Cayman)': [
      'George Town',
      'Camana Bay',
      'Seven Mile Beach',
    ],
    'RBC Royal Bank (Cayman)': ['George Town', 'Camana Bay'],
    'Fidelity Bank (Cayman)': ['George Town', 'Camana Bay'],
  };
