      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Thank you for helping keep HotBite safe. Our trust & safety team will review your report and take appropriate action.',
          ...
          if (widget.reportedUserName != null) ...[
            Card(
              ...
              child: ListTile(
                ...
                subtitle: const Text('HotBite Trust & Safety', style: TextStyle(fontSize: 12)),
              ),
            ),
