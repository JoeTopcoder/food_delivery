    ...
    return const LegalPolicyScreen(
      ...
      sections: [
        LegalSection(
          ...
          body:
              'By downloading, installing, or using the HotBite mobile application ("App") operated by HotBite Delivery Limited ("HotBite", "we", "us", "our"), you agree to be bound by these Terms & Conditions. If you do not agree to these terms, do not use the App.',
        ),
        LegalSection(
          heading: '2. Eligibility',
          body:
              'You must be at least 18 years of age to use HotBite. By using the App, you represent and warrant that you are 18 or older and have the legal capacity to enter into these Terms.',
        ),
        LegalSection(
        ...
        LegalSection(
          ...
          body:
              'All content, trademarks, logos, and software in the App are owned by or licensed to HotBite and are protected by applicable intellectual property laws. You may not reproduce, distribute, or create derivative works without our written permission.',
        ),
        LegalSection(
          heading: '14. Limitation of Liability',
          body:
              'To the fullest extent permitted by law, HotBite shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the App. HotBite acts as a technology platform connecting customers, drivers, and providers; we are not liable for the quality, safety, or legality of products or services provided by third-party partners.',
        ),
        LegalSection(
