      ...
      sections: [
        LegalSection(
          ...
          body:
              ...
              '• After restaurant accepts but before preparation starts: Cancellation is permitted; refund is at HotBite\'s discretion. The service fee is non-refundable.\n\n'
        ...
        LegalSection(
          ...
          body:
              'You may cancel your HotBite+ subscription at any time. Your subscription remains active until the end of the current billing period. No partial-month refunds are issued. To cancel, go to Settings → Subscription → Cancel Subscription.',
        ),
        LegalSection(
