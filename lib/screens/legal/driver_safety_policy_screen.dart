    ...
    return const LegalPolicyScreen(
      ...
      sections: [
        LegalSection(
          heading: '1. Purpose',
          body:
              'This Driver Safety Policy applies to all delivery and ride-sharing partners ("drivers") operating on the HotBite platform. It establishes minimum safety standards to protect drivers, customers, and the public.',
        ),
        LegalSection(
        ...
        LegalSection(
          ...
          body:
              'Do not drive if you are excessively fatigued. Take regular breaks during long shifts. HotBite may automatically notify you to take a break if you have been continuously active beyond recommended hours. Your safety is more important than any individual delivery.',
        ),
        LegalSection(
        ...
        LegalSection(
          ...
          body:
              'All driver applicants are subject to a background check before approval. Drivers must notify HotBite of any changes to their criminal record or driving record. HotBite reserves the right to deactivate accounts that no longer meet safety standards.',
        ),
        LegalSection(
          heading: '9. Insurance Disclaimer',
          body:
              'HotBite does not provide vehicle insurance for drivers. You are responsible for maintaining adequate coverage. Some jurisdictions require specific ride-sharing insurance endorsements; it is your responsibility to comply with local insurance laws.',
        ),
        LegalSection(
