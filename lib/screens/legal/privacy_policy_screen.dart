    ...
    return const LegalPolicyScreen(
      ...
      sections: [
        LegalSection(
          ...
          body:
              'HotBite Delivery Limited ("HotBite", "we", "us", or "our") operates the HotBite mobile application and related services (collectively, the "Service"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Service. By using HotBite, you agree to the collection and use of information in accordance with this policy.',
        ),
        LegalSection(
