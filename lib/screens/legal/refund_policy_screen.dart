    ...
    return const LegalPolicyScreen(
      ...
      sections: [
        LegalSection(
          heading: '1. Overview',
          body:
              'HotBite strives to ensure every order and booking meets your expectations. If something goes wrong, we want to make it right. This policy explains when and how refunds are issued.',
        ),
        LegalSection(
        ...
        LegalSection(
          ...
          body:
              'Approved refunds to the original payment method typically take 5–10 business days, depending on your bank or card issuer. Store credits are applied immediately to your HotBite wallet and can be used on your next order.',
        ),
        LegalSection(
