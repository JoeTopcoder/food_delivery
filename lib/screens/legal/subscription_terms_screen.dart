...
class SubscriptionTermsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const LegalPolicyScreen(
      ...
      sections: [
        LegalSection(
          heading: '1. HotBite+ Subscription Plans',
          body:
              'HotBite offers optional subscription plans ("HotBite+") that provide delivery benefits for a recurring monthly fee. Current plans are displayed in the app on the Subscription screen. Plan details, pricing, and included benefits are subject to change with prior notice.',
        ),
        LegalSection(
          heading: '2. Billing',
          body:
              'Your subscription is billed monthly on the date you first subscribed. The charge appears as "HotBite+" or "HotBite Technologies" on your payment statement. All charges are in USD unless otherwise indicated. By subscribing, you authorize HotBite to charge your selected payment method automatically each billing period.',
        ),
        LegalSection(
          heading: '3. What Is Included',
          body:
              'Each plan includes a set number of free or reduced-fee deliveries per month, as described on the plan selection screen. Delivery benefits apply to eligible food and grocery orders placed through the HotBite app. Benefits do not carry over to the following month and are not transferable.',
        ),
        LegalSection(
        ...
        LegalSection(
          ...
          body:
              'If you subscribed through the Apple App Store or Google Play Store, billing is managed by Apple or Google under their respective terms. To cancel or manage your subscription, visit your App Store or Play Store subscription settings. HotBite cannot process refunds for in-app purchases made through these stores; contact Apple or Google support.',
        ),
        LegalSection(
          heading: '11. Contact',
          body:
