                    ...
                    _MenuGroup(
                      ...
                      items: [
                        ...
                        _MenuItem(
                          ...
                          onTap: () =>
                              Navigator.of(context).pushNamed('/group-orders'),
                        ),
                        _MenuItem(
                    ...
                    _MenuGroup(
                      ...
                      items: [
                        ...
                        _MenuItem(
                          ...
                          sub: 'Get help from the HotBite team',
                          onTap: () => Navigator.of(
                            context,
            ...
            onPressed: () async {
              ...
              try {
                final updated = await ref
                    ...
                    .updateUserProfile(userId: currentUser!.id, phone: phone);
                if (updated != null) {
                  ref.read(userSessionOverrideProvider.notifier).state =
                      updated;
                }
...
class _HeroHeader extends StatelessWidget {
  ...
  const _HeroHeader({required this.currentUser, required this.onEditPhoto});
  ...
  Widget build(BuildContext context) {
    ...
    return IntrinsicHeight(
      child: Row(
        children: [
          Expanded(
            child: _Stat(value: '$orders', label: 'Orders'),
          ),
          VerticalDivider(
...
class _Stat extends StatelessWidget {
  ...
  const _Stat({required this.value, required this.label, this.isGreen = false});
