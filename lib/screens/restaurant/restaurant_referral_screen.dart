                  ...
                  ? SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () => SharePlus.instance.share(ShareParams(
                          text: 'List your restaurant on HotBite! Use my referral code $code when you sign up and get \$${EarningConfig.restaurantRefCredits.toStringAsFixed(0)} in ad credits. Download the app now.',
                        )),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _HowItWorksStep(
                    step: '2',
                    text:
                        'They register their restaurant on HotBite using your code',
                    color: const Color(0xFF0891B2),
                  ),
                  _HowItWorksStep(
                    step: '3',
