        ...
        child: Row(
          children: [
            ...
            if (MediaQuery.of(context).size.width > 900) ...[
              for (final link in ['Why HotBite', 'How It Works', 'Pricing', 'Support'])
                Padding(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                const Text(
                  'Join HotBite and keep more of your hard-earned revenue\nwhile we help you reach more local customers.',
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            const Text('on HotBite', style: TextStyle(color: Colors.white38, fontSize: 12)),
                          ],
                        ),
                      ],
                    ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          const Text('"HotBite helped us reduce fees and increase our online orders. It\'s a win-win!"', style: TextStyle(fontSize: 11, color: _navyLight, fontStyle: FontStyle.italic, height: 1.4)),
                          const SizedBox(height: 6),
...
class _HowItWorks extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Text('How HotBite Works for Your Restaurant', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: _navy)),
          const SizedBox(height: 6),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Join HotBite today and start receiving more orders with lower commissions.', style: TextStyle(fontSize: 12, color: _slate, height: 1.5)),
                    const SizedBox(height: 16),
                    SizedBox(
                      width: double.infinity,
  ...
  static const _steps = [
    ...
    (Icons.delivery_dining_rounded, 'Get Orders', 'Receive more orders from local customers on HotBite.'),
...
class _TestimonialsSection extends StatelessWidget {
  ...
  static const _testimonials = [
    ('HotBite helped us cut delivery fees by 40%. Our monthly profit went up significantly in just the first month.', 'Michael T.', 'Pizza Palace, New York'),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text('Join 500+ restaurants already using HotBite to reach more customers\nand keep more of their hard-earned revenue.',
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    const Text('HotBite', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 16)),
                  ],
                ),
