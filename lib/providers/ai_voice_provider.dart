...
class AiVoiceNotifier extends StateNotifier<AiVoiceState> {
  ...
  String _greetingFor(String role) {
    switch (role) {
      case 'driver':
        return 'Hi! I\'m your HotBite assistant. Ask me about your current delivery.';
      case 'admin':
        return 'Hi! I\'m the HotBite admin assistant. How can I help?';
      default:
        return 'Hi! I\'m your HotBite assistant. Ask me about your order or anything else.';
    }
  }
